          ...
          {data.map((homeItem) => {
            return (
              <MenuHomes
                ...
                price={homeItem.content.price}
                room={homeItem.detail.rooms}
                bedroom={homeItem.detail.bedrooms}
                bathroom={homeItem.detail.bathrooms}
                area={homeItem.content.area}
                address={homeItem.location.address}
                city={homeItem.location.city}
                path={homeItem.content.path}
                priceRent={homeItem.content.priceRent}
              />
            )
          })}
        </div>
